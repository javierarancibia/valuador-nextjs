...
const ReportsTable: React.FC<Props> = ({ reports }) => {
    ...
    const deleteReport = async (reportId: string) => {
        ...
        const response = await fetch('/api/reports', {
            ...
            body: JSON.stringify({ reportId }),  // Ensure reportId is sent as an object
        });
    ...
    const handleDelete = (reportId: string) => mutation.mutate(reportId);
    ...
    return (
        ...
        <div className="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
            ...
            <div className="col-span-1 flex items-center">
                <p className="font-medium">Borrar</p>
            </div>
        </div>
        ...
        {reports.map((report) => (
            ...
            >
                ...
                <div className="col-span-1 flex items-center">
                    <Link href={`informes/${report.property}/${report._id}`} className="hover:text-primary">
                        <svg
                ...
                {/* Delete Report */}
                <div className="col-span-1 flex items-center">
                    <button className="hover:text-primary" onClick={() => handleDelete(report._id)}>
                        <svg
                            className="fill-current"
                            width="18"
                            height="18"
